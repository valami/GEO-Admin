		...
		<div class="modal-body">					
			<form method="post" action="#">				
				...
				<div class="form-group">
					...
					<input type="text" name="mac" class="form-control" value=<?php print $SelectedDevice->mac; ?>>
				</div>
				<div class="form-group">
					<label for="usr">IP Cím:</label>
					<input type="text"  name="ip" class="form-control" value=<?php print $SelectedDevice->ip; ?> >
				</div>
