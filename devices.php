	...
	<body>
		...
		<div class="container static">
                ...
                <div class="row">
					...
					<?php 
						if ((int) $_SESSION['ulevel']==1 )
						{ print "<button type='submit' value='add' class='glyphicon glyphicon-plus btn btn-success' name='btn'>Hozzáadás</button>";}
					?>					
					</form>
					</div>
                    <div class="col-sm-4">
